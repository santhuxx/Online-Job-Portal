...
<html>
    ...
    <div class="btn-group">
        ...
        <button class="button" type="button"><a href="jseeker_reg.php">For Job Seekers</a></button>       
    </div>
<!------------------------------------------------------------------------------------------------------------>
    <center><form action="add_emp.php" method="post">
        <center>
        <h1 style="color:black;">Register now for Employer</h1>
        </center>
       
        
            <label>Job Title</label>
            <input type="text"name="Job_title" class="form-control" id="p_title" placeholder="Accountant" required><br/><br/>
        
          
            <label>Company</lable>
            <input type="text"name="Company" class="form-control" id="p_company" placeholder="ABC (Pvt)Ltd" required><br/><br/>
        ...
        <button onclick="myFunction()" class="sumbit" name="add_emp">
            <span class="btnText">Submit</span>
            <i class="uil uil-navigator"></i>
        </button>
        <!-- <input type="button" class="sumbit" name="add_emp" value="Submit"/> -->
